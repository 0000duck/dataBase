 ...
 * @see JTable
 */
public class TableCellRendererJTextArea extends JLabel implements
	 ...
	 */
	public TableCellRendererJTextArea() {
		super();
		setOpaque(true);
...
//		renderer.setBackground(row % 2 == 0 ? null : new Color(245, 245, 245));
//		
//		return renderer;
//	}
...
//	}
    ...
    protected void setValue(Object value) {
		if (value instanceof JTextArea) {
			...
			//super.append(area1);
			super.setText( ((JTextArea) value).getText());
			//super.setText(jTextArea);   
		} else if (value instanceof DummyIconPath) {
			ImageIcon icon = LoadImageIcon.createImageIcon("/img/Folder_20x20.png","");
			super.setIcon(icon);
			setText(null);
		} else if (value instanceof DummyFileInfo) {
			ImageIcon icon = LoadImageIcon.createImageIcon("/img/Edit_20x20.png","");
			super.setIcon(icon);
			setText(null);
		} else {
			setIcon(null);
	 ...
	 */
	public static class UIResource extends TableCellRendererJTextArea implements
